...
class ApiReservationChecker {
     ...
     */
    async getAllReservations(startDate) {
     ...
     */
    parseReservationsToMap(apiResponse) {
     ...
     */
    findBookedSlotsForDate(dateInfo, allReservations) {
        const bookedSlots = [];
...
exports.default = ApiReservationChecker;
//# sourceMappingURL=apiReservationChecker.js.map